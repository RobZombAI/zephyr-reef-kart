...
async function run() {
  console.log("Launching Puppeteer for live verification of https://robzombai.github.io/zephyr-reef-kart/?v=zephyr-6.5.0 ...");
  ...
  try {
    ...
    await pageMob.goto("https://robzombai.github.io/zephyr-reef-kart/?v=zephyr-6.5.0&t=" + Date.now(), { waitUntil: "networkidle2", timeout: 35000 });
    ...
    await pageDesk.goto("https://robzombai.github.io/zephyr-reef-kart/?v=zephyr-6.5.0&t=" + Date.now(), { waitUntil: "networkidle2", timeout: 35000 });
